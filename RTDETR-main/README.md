...
The script will automatically load the dataset from `dataset/data.yaml` and use the `DBS-RTDETR.yaml` configuration file.
Trained weights and logs will be saved under `runs/train/exp`.