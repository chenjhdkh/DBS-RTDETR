...
classes = ['A330', 'A320/321', 'A220', 'ARJ21', 'Boeing737', 'Boeing787', 'other']

parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default='/mnt/workspace/datasetsar/images/val',type=str, help="path of images")
parser.add_argument('--label_path', default='/mnt/workspace/datasetsar/labels/val',type=str, help="path of labels .txt")
